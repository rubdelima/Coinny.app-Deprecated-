...
import 'package:learn/pages/children/acheivements.dart';
      ...
      children: [
        if (withText)
          const CoinnyWidgetTitle(
              ...
              description: "Reconheça os seus filhos pelas suas vitórias!"),
        if (withText)
          const SizedBox(
            height: 12,
          ),
                  ...
                  child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Image.asset(
                              'assets/images/appIcons/icon-show-conquist.png'),
                        ],
                      )),
                  onTap: () {
                    Navigator.push(
